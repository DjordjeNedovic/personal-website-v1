...
export default function Footer() {
    return (
        <footer className="w-full flex sm:flex-row pt-6 border-t-2 mt-2 items-center">
            ...
            <p className="flex-auto text-right">Made from <Link href="https://bejamas-nextjs-blog.netlify.app/" className="underline underline-offset-1"  aria-label="app theme"> Next.js Blog Theme</Link> </p>
            <p className="flex-auto text-right">Powered by <Link href="https://www.netlify.com/" className="underline underline-offset-1"  aria-label="Netlify"> Netlify</Link></p>
        </footer>
    );
}
